...
const buttonVariants = cva(
   `inline-flex items-center justify-center whitespace-nowrap gap-2 rounded-lg border border-border/60 hover:border-border
    ...
    active:pt-[9px] active:pb-[7px] active:shadow-inner`,
   {
      variants: {
         variant: {
            default: `bg-primary text-primary-foreground py-[8px] hover:bg-border/30 active:bg-border/40`,
            destructive: `bg-destructive text-destructive-foreground hover:bg-destructive/90`,
            outline: `bg-background hover:bg-accent/50 hover:text-accent-foreground`,
            secondary: `bg-secondary text-secondary-foreground hover:bg-accent`,
            ghost: "hover:bg-border/50 hover:text-foreground active:py-2 border-0",
